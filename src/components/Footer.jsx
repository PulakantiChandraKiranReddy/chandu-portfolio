  ...
  return (
    <footer>
      ...
      <div className="footer__socials">
        <a href="mailto:chandrakiranreddy2003@gmail.com">
          <FaEnvelope />
        </a>
        <a href="https://www.linkedin.com/in/chandra-kiran-reddy-258b94257/">
          <FaLinkedinIn />
        </a>
        <a href="https://github.com/PulakantiChandraKiranReddy">
          <FaGithubAlt />
        </a>
