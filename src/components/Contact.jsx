      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:chandrakiranreddy2003@gmail.com" target="_blank">
              Send a message
            </a>
          </article>
          ...
          <article className="contact__option">
            ...
            <a
              href="https://www.instagram.com/chandu.reddy20?igsh=MTVqZzhtcjBqamptNA=="
              target="_blank"
            >
              Send a message
            </a>
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <textarea
            name="message"
            rows="7"
            placeholder="Hi Chandu, I have a question..."
            required
          ></textarea>
