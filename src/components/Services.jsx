            ...
            <div className="container services__containter">
                ...
                <article className="service">
                    ...
                    <ul className='service__list'>
                        <li>
                            <BsCheckLg className='service__list-icon' />
                            <p><b>Microsoft CyberSecurity Analysist </b>Course Certificate on Coursera</p>
                        </li>
                        <li>
                            <BsCheckLg className='service__list-icon' />
                        ...
                        <li>
                            <BsCheckLg className='service__list-icon' />
                            <p><b>Ethical Hacking from scratch</b> Course Certificate on Udemy</p>
                        </li>
                    </ul>
                </article>
                {/* End of ui/ux */}
